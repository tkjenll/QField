...
if(VCPKG_TARGET_IS_WINDOWS AND NOT VCPKG_TARGET_IS_MINGW)
    ...
    if(VCPKG_TARGET_IS_IOS)
      execute_process(COMMAND xcodebuild -version -sdk iphoneos Path OUTPUT_VARIABLE SDKPATH OUTPUT_STRIP_TRAILING_WHITESPACE)
      file(READ ${SOURCE_PATH}/src/Makefile.global.in filedata)
      string(REGEX REPLACE "PG_SYSROOT = @PG_SYSROOT@" "PG_SYSROOT = ${SDKPATH}" filedata "${filedata}")
      file(WRITE ${SOURCE_PATH}/src/Makefile.global.in "${filedata}")
    endif()
