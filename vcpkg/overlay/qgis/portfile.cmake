...
elseif(VCPKG_TARGET_IS_LINUX OR VCPKG_TARGET_IS_OSX) # Build in UNIX
    ...
    list(APPEND QGIS_OPTIONS_DEBUG -DGDAL_LIBRARY:FILEPATH="${CURRENT_INSTALLED_DIR}/debug/lib/${VCPKG_TARGET_STATIC_LIBRARY_PREFIX}gdal${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX} ${CURRENT_INSTALLED_DIR}/debug/lib/${VCPKG_TARGET_STATIC_LIBRARY_PREFIX}xml2${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX} ${CURRENT_INSTALLED_DIR}/debug/lib/${VCPKG_TARGET_STATIC_LIBRARY_PREFIX}rttopo${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
    list(APPEND QGIS_OPTIONS_RELEASE -DGDAL_LIBRARY:FILEPATH="${CURRENT_INSTALLED_DIR}/lib/${VCPKG_TARGET_STATIC_LIBRARY_PREFIX}gdal${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX} ${CURRENT_INSTALLED_DIR}/lib/${VCPKG_TARGET_STATIC_LIBRARY_PREFIX}xml2${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX} ${CURRENT_INSTALLED_DIR}/lib/${VCPKG_TARGET_STATIC_LIBRARY_PREFIX}rttopo${VCPKG_TARGET_STATIC_LIBRARY_SUFFIX}")
    list(APPEND QGIS_OPTIONS_DEBUG "-DCMAKE_CXX_STANDARD_LIBRARIES=${CURRENT_INSTALLED_DIR}/debug/lib/libgeos_cd.a ${CURRENT_INSTALLED_DIR}/debug/lib/libgeosd.a ${CURRENT_INSTALLED_DIR}/debug/lib/librttopo.a ${CURRENT_INSTALLED_DIR}/debug/lib/libxml2.a ${CURRENT_INSTALLED_DIR}/debug/lib/libopenjp2.a ${CURRENT_INSTALLED_DIR}/debug/lib/liblzmad.a ${CURRENT_INSTALLED_DIR}/debug/lib/libpng.a ${CURRENT_INSTALLED_DIR}/debug/lib/libz.a ${CURRENT_INSTALLED_DIR}/debug/lib/libjson-c.a ${CURRENT_INSTALLED_DIR}/debug/lib/libfreexl.a ${CURRENT_INSTALLED_DIR}/debug/lib/libjpeg.a ${CURRENT_INSTALLED_DIR}/debug/lib/libtiffd.a ${CURRENT_INSTALLED_DIR}/debug/lib/liblzmad.a ${CURRENT_INSTALLED_DIR}/debug/lib/libgif.a ${CURRENT_INSTALLED_DIR}/debug/lib/libbz2d.a ${CURRENT_INSTALLED_DIR}/debug/lib/libcfitsio.a $ENV{Qt5_DIR}/lib/libQt5DBus.so ${CURRENT_INSTALLED_DIR}/debug/lib/libgslcblasd.a ${CURRENT_INSTALLED_DIR}/debug/lib/libcurl-d.a ${CURRENT_INSTALLED_DIR}/debug/lib/libssl.a ${CURRENT_INSTALLED_DIR}/debug/lib/libcrypto.a ${CURRENT_INSTALLED_DIR}/debug/lib/libhdf5_hl_debug.a ${CURRENT_INSTALLED_DIR}/debug/lib/libhdf5_debug.a -pthread -ldl")
    list(APPEND QGIS_OPTIONS_RELEASE "-DCMAKE_CXX_STANDARD_LIBRARIES:FILEPATH=${CURRENT_INSTALLED_DIR}/lib/libgeos_c.a ${CURRENT_INSTALLED_DIR}/lib/libgeos.a ${CURRENT_INSTALLED_DIR}/lib/librttopo.a ${CURRENT_INSTALLED_DIR}/lib/libxml2.a ${CURRENT_INSTALLED_DIR}/lib/libopenjp2.a ${CURRENT_INSTALLED_DIR}/lib/liblzma.a ${CURRENT_INSTALLED_DIR}/lib/libpng.a ${CURRENT_INSTALLED_DIR}/lib/libz.a ${CURRENT_INSTALLED_DIR}/lib/libjson-c.a ${CURRENT_INSTALLED_DIR}/lib/libfreexl.a ${CURRENT_INSTALLED_DIR}/lib/libjpeg.a ${CURRENT_INSTALLED_DIR}/lib/libtiff.a ${CURRENT_INSTALLED_DIR}/lib/liblzma.a -pthread ${CURRENT_INSTALLED_DIR}/lib/libgif.a ${CURRENT_INSTALLED_DIR}/lib/libbz2.a ${CURRENT_INSTALLED_DIR}/lib/libcfitsio.a $ENV{Qt5_DIR}/lib/libQt5DBus.so -ldl ${CURRENT_INSTALLED_DIR}/lib/libgslcblas.a ${CURRENT_INSTALLED_DIR}/lib/libcurl.a ${CURRENT_INSTALLED_DIR}/lib/libssl.a ${CURRENT_INSTALLED_DIR}/lib/libcrypto.a ${CURRENT_INSTALLED_DIR}/lib/libhdf5_hl.a ${CURRENT_INSTALLED_DIR}/lib/libhdf5.a")
    if("server" IN_LIST FEATURES)
...
function(copy_path basepath)
    ...
    if("debug-tools" IN_LIST FEATURES)
        file(GLOB ${basepath}_DEBUG_PATH ${CURRENT_PACKAGES_DIR}gc${basepath}/*)
        if( ${basepath}_DEBUG_PATH )
            file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}gctools/${PORT}/${basepath})
            file(COPY ${${basepath}_DEBUG_PATH} DESTINATION ${CURRENT_PACKAGES_DIR}gctools/${PORT}/${basepath})
        endif()
    endif()

    if(EXISTS "${CURRENT_PACKAGES_DIR}gc${basepath}/")
        file(REMOVE_RECURSE ${CURRENT_PACKAGES_DIR}gc${basepath}/)
    endif()
endfunction()
...
file(GLOB QGIS_CMAKE_PATH_DEBUG ${CURRENT_PACKAGES_DIR}gc*.cmake)
...
file(GLOB QGIS_TOOL_PATH_DEBUG ${CURRENT_PACKAGES_DIR}gcbin/*${VCPKG_TARGET_EXECUTABLE_SUFFIX} ${CURRENT_PACKAGES_DIR}/debug/*${VCPKG_TARGET_EXECUTABLE_SUFFIX})
if(QGIS_TOOL_PATH_DEBUG)
    if("debug-tools" IN_LIST FEATURES)
        file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}gctools/${PORT}/bin)
        file(COPY ${QGIS_TOOL_PATH_DEBUG} DESTINATION ${CURRENT_PACKAGES_DIR}gctools/${PORT}/bin)
        file(REMOVE_RECURSE ${QGIS_TOOL_PATH_DEBUG})
        file(GLOB QGIS_TOOL_PATH_DEBUG ${CURRENT_PACKAGES_DIR}gcbin/* )
        file(COPY ${QGIS_TOOL_PATH_DEBUG} DESTINATION ${CURRENT_PACKAGES_DIR}gctools/${PORT}/bin)
    else()
        file(REMOVE_RECURSE ${QGIS_TOOL_PATH_DEBUG})
    endif()
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    if("debug-tools" IN_LIST FEATURES)
        vcpkg_copy_tool_dependencies_ex(${CURRENT_PACKAGES_DIR}gctools/${PORT}/bin ${CURRENT_PACKAGES_DIR}/debug/tools/${PORT}/bin debug/bin)
        vcpkg_copy_tool_dependencies_ex(${CURRENT_PACKAGES_DIR}gctools/${PORT}/plugins ${CURRENT_PACKAGES_DIR}/debug/tools/${PORT}/bin debug/bin)
    endif()
    if("server" IN_LIST FEATURES)
        vcpkg_copy_tool_dependencies_ex(${CURRENT_PACKAGES_DIR}/tools/${PORT}/server ${CURRENT_PACKAGES_DIR}/tools/${PORT}/bin bin)
        if("debug-tools" IN_LIST FEATURES)
            vcpkg_copy_tool_dependencies_ex(${CURRENT_PACKAGES_DIR}gctools/${PORT}/server ${CURRENT_PACKAGES_DIR}/debug/tools/${PORT}/bin debug/bin)
        endif()
    endif()
endif()

file(REMOVE_RECURSE
    ${CURRENT_PACKAGES_DIR}gcinclude
)
