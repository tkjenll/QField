...
set(QGIS_REF d0a3ceab91d02943408508809683ee7b1ae14675)
...
if(VCPKG_TARGET_IS_WINDOWS)
    ...
    file(GLOB_RECURSE PLUGINS ${CURRENT_PACKAGES_DIR}/tools/${PORT}/plugins *.so)
    file(MAKE_DIRECTORY ${CURRENT_PACKAGES_DIR}/lib/${PORT})
    foreach(PLUGIN ${PLUGINS})
        file(COPY ${PLUGIN} ${CURRENT_PACKAGES_DIR}/lib/${PORT})
    endforeach()
endif()
